...
function _ThirdwebConnect(taskId, wallet, chainId, password, cb) {
 var id = UTF8ToString(taskId);
 var idSize = lengthBytesUTF8(id) + 1;
 var idPtr = _malloc(idSize);
 stringToUTF8(id, idPtr, idSize);
 window.bridge.connect(UTF8ToString(wallet), chainId, UTF8ToString(password)).then(address => {
  if (address) {
...
async function _ThirdwebFundWallet(taskId, payload, cb) {
 ...
 var idPtr = _malloc(idSize);
 stringToUTF8(id, idPtr, idSize);
 window.bridge.fundWallet(UTF8ToString(payload)).then(() => {
  dynCall_viii(cb, idPtr, idPtr, null);
 }).catch(err => {
  var msg = err.message;
  var bufferSize = lengthBytesUTF8(msg) + 1;
...
function _ThirdwebInvoke(taskId, route, payload, cb) {
 ...
 var idPtr = _malloc(idSize);
 stringToUTF8(id, idPtr, idSize);
 window.bridge.invoke(UTF8ToString(route), UTF8ToString(payload)).then(returnStr => {
...
function _ThirdwebInvokeListener(taskId, route, payload, action) {
 window.bridge.invokeListener(UTF8ToString(taskId), UTF8ToString(route), UTF8ToString(payload), action, (jsAction, jsTaskId, jsResult) => {
  var jsId = jsTaskId;
...
async function _ThirdwebSwitchNetwork(taskId, chainId, cb) {
 ...
 var idPtr = _malloc(idSize);
 stringToUTF8(id, idPtr, idSize);
 window.bridge.switchNetwork(chainId).then(() => {
  dynCall_viii(cb, idPtr, null, null);
 }).catch(err => {
  var msg = err.message;
  var bufferSize = lengthBytesUTF8(msg) + 1;
...
var dynCall_viiiiffifi = Module["dynCall_viiiiffifi"] = createExportWrapper("dynCall_viiiiffifi");
...
var dynCall_vifiiffi = Module["dynCall_vifiiffi"] = createExportWrapper("dynCall_vifiiffi");

var dynCall_vifiifii = Module["dynCall_vifiifii"] = createExportWrapper("dynCall_vifiifii");

var dynCall_vifiififii = Module["dynCall_vifiififii"] = createExportWrapper("dynCall_vifiififii");

var dynCall_vifiififiii = Module["dynCall_vifiififiii"] = createExportWrapper("dynCall_vifiififiii");

var dynCall_vifiififiiii = Module["dynCall_vifiififiiii"] = createExportWrapper("dynCall_vifiififiiii");

var dynCall_viifiififii = Module["dynCall_viifiififii"] = createExportWrapper("dynCall_viifiififii");
...
var dynCall_viiiiffiiifiii = Module["dynCall_viiiiffiiifiii"] = createExportWrapper("dynCall_viiiiffiiifiii");

var dynCall_viiffiiifii = Module["dynCall_viiffiiifii"] = createExportWrapper("dynCall_viiffiiifii");
...
var dynCall_ififfi = Module["dynCall_ififfi"] = createExportWrapper("dynCall_ififfi");
